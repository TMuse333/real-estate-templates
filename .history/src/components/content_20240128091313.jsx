            ...
            >
                {rev ? (
                    <div className="description-box">
                        ...
                        john 
                          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem expedita tempore itaque ducimus alias repellendus atque officia sed perspiciatis ipsam.
                          <br/>
                            {link != null && 
                                <Link to={link}>
                ...
                {rev ? null : (
                    <div className="description-box">
                        ...
                        >
                           Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam dolores iure suscipit tenetur id delectus quia repudiandae culpa tempora distinctio?
                           <br/>
                           <br/>
                           Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium, commodi vero! Neque maiores, vitae est ea ab cumque provident fugiat unde nesciunt ducimus excepturi fugit inventore, aut amet ex odit.
                            <br/>
                            {link != null && 
                                <Link to={link}>
                                    <button className="button">{linkText}</button>
