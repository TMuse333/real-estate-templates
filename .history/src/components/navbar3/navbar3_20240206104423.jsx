...
useEffect(() => {
  ...
  const handleListEntry = (index) => {
    ...
    console.log('ressource indexed!',resourceIndex)
  }
          ...
          <ul className="nav3-desktop-menu">
            ...
            // onMouseLeave={()=>handleSubLeave()}
              ...
              >
                ...
                About
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta tempore vitae fugiat necessitatibus sit ipsum optio nulla ratione earum eaque.
                </p>
              </li>
