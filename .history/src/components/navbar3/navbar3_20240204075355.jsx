...
const Navbar3 = () => {
    ...
    useEffect(() => {
        ...
        if (servicesElement) {
          ...
          const { left } = servicesElement.getBoundingClientRect();
      
          // Use the left position directly, e.g., for logging or other purposes
          console.log('Left position of "services":', left);
        }
...
style={!isDesktop ? secondaryStyle : secondaryStyle}
