...
>
  ...
  <ul className={`${!isDesktop ? 'nav3-contents secondary' : 'desktop-submenu'}`} style={!isDesktop ? secondaryNavStyle(0) : null}>
    <p className="back-button" onClick={subMenuReturn} onMouseEnter={() => handleListEnter(4)} style={{...listStyle(4), opacity: 1}} onMouseLeave={handleMouseLeave}>
      Back
    </p>
    <li className="sub-li">
      <button className="sub-button" onMouseEnter={() => handleListEnter(1)} style={listStyle(1)} onMouseLeave={handleMouseLeave}>
        Web dev
      </button>
    </li>
    <li className="sub-li">
      <button className="sub-button" onMouseEnter={() => handleListEnter(2)} style={listStyle(2)} onMouseLeave={handleMouseLeave}>
        Copywriting
      </button>
    </li>
    <li className="sub-li">
...
<li onClick={() => handleMenuItemClick(1)} className='main-list about'>
  About 
