      ...
      if ((elementTop - windowHeight / 2) + 200 <= 0) {
        ...
        setTextPosition((prevTextPosition) => {
          ...
          if (newTextPosition >= 40) {
            const opacityChange = 0.00055 * (newTextPosition - 40); // Adjust the rate of opacity change
            ...
            const opacityChange = 0.005 * (50 - newTextPosition); // Adjust the rate of opacity change
            setVideoOpacity((prevOpacity) => {
