...
const FullScreenSlide = ({ video, image, id }) => {
    ...
    const handleWheel = (event) => {
      ...
      if ((elementTop - windowHeight / 2) + 200 <= 0) {
        ...
        setTextPosition((prevTextPosition) => {
          const newTextPosition = prevTextPosition + (scrollPower / 20);
          ...
          if (textPercentage >= 90) {
            // Set body overflow back to auto
            document.body.style.overflow = 'auto';
            console.log('text is at the top')
          }
  ...
  }, [setScrollPower, scrollPower, setTextPosition, setBottomReached, textRef]);
   // Only include setScrollPower as a dependency
