    ...
    points:[
      {
        ...
        description: `            Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem sint odio adipisci sed velit dolorum a, quo sit iusto laboriosam.`,
      },
      {
        image:image,
...
export const docsIntro = 'The sale of your home will require a combination of documents unique to its characteristics.\n\n '+ 

'I look forward to explaining which documents your listing requires and the purpose each one plays in the successful sale of your home.'


export const overview2Data = [
    {
        name: 'Aspect 1',
        points:[
            'Quantum realm power',
...
export const slideShowPictures = [
    'src/media/aboubacar-5-fire.png',
    'src/media/q3-visuals-logo-2.png',
    'src/media/threeSaiyans.jpg',
    'src/media/vegeta-battle.png'
]